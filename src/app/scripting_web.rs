...
/// rx,ry,rz en °, sx,sy,sz, r,g,b, tapped/triggered/exited/anim), `dt`, `time`,
/// `input`, `tilt`, puis relit les champs modifiés) — cf. la doc de module pour ce
/// qui diffère en interne (pas de fermetures capturantes côté hôte).
