...
def build_creature(name, bones, idle_keys, walk_keys, cam=1.0):
    ...
    # Appoint opposé : sans lui, les teintes sombres (tiges, membranes) se
    # fondent dans le fond noir de la vignette et semblent « manquantes ».
    bpy.ops.object.light_add(
...
def golem():
    ...
    core = material("Golem38Core", (0.95, 0.55, 0.12), roughness=0.3)
