...
Copie directe de check_hamlet_pack.py (hamlet_ -> siege_) : même décor
STATIQUE, mêmes contraintes (un seul mesh joint, pas de vertex sous le sol,
pas de texture référencée, budget indicatif). Voir check_hamlet_pack.py pour
le détail des vérifications, non dupliqué ici.
